...
def sanitize_response(response: str):
    """Sanitize response to remove invalid control characters before parsing JSON."""
...
def main():
    ...
    with st.sidebar:
        ...
        - Assess Resume Alignment with Job Descriptions
        - Discover Critical Missing Keywords
        - Receive Tailored Suggestions for Resume Improvement
        """)

    # Main content
    st.title("📄 Smart CVFit Analyzer")
    st.subheader("Tailor Your Resume for ATS Success")
